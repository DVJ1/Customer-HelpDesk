...
export default function TicketSheet({ ticket, onClose, users, onUpdate, currentUser }) {
  ...
  const handleStatusChange = async (e) => {
    ...
    try {
      const res = await axios.put(`https://customer-helpdesk.onrender.com/api/tickets/${localTicket._id}`, {
        status: newStatus,
  ...
  const submitComment = async () => {
    ...
    setSubmitting(true);
    try {
      const res = await axios.post(`https://customer-helpdesk.onrender.com/api/tickets/${localTicket._id}/comments`, {
        text: comment,
